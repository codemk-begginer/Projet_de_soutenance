                ...
                <form id="contact-form" method="post" action="" role="form">
                    ...
                    <div class="row">
                       ...
                       <div class="col-md-12">
                        ...
                        <a href = "Mon_resultat_view.jsp"><button type="button" class="btn btn-outline-primary btn-icon-text">
                                            <i class="mdi mdi-file-check btn-icon-prepend"></i> Afficher mon resultat</button></a>

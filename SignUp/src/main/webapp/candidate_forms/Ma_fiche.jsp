                ...
                <form id="contact-form" method="post" action="" role="form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <input id="firstname" type="" name="firstname" class="form-control" placeholder="Votre Matricule" >
                            <p class="comments"></p>
                        </div>
 
                        <div class="col-md-6">
                            <label for="firstname">Nom(tel que saisie pr̩c̩dament)</label>
                            <input id="firstname" type="" name="firstname" class="form-control" placeholder="Votre nom">
                            <p class="comments"></p>
                        </div>
                        <div class="col-md-6">
                            <label for="name">Prenom(tel que saisie pr̩c̩dament)</label>
                            <input id="name" type="text" name="name" class="form-control" placeholder="Votre Pr̩nom">
                            <p class="comments"></p>
                        </div>
                        <div class="col-md-6">
                            <label for="email">Date de naissance</label>
                            <input id="email" type="Date" name="email" class="form-control" >
                            <p class="comments"></p>
                        </div>
                        <div class="col-md-6">
                       ...
                       <div class="mdi-button">
                          <a href = "preview.jsp"><button type="button" class="btn btn-outline-primary btn-icon-text">
                                            <i class="mdi mdi-file-check btn-icon-prepend"></i> Afficher ma candidature </button></a>
                                            
                                         <a href = "candidature.jsp"><button type="button" class="btn btn-outline-primary btn-icon-text">
                                            <i class="mdi mdi-view-list btn-icon-prepend"></i> Modifier ma candidature </button></a>   
                                        <p class="comments"></p>
                       </div>

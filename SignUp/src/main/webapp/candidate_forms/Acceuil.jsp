...
<body class="index-page" style="margin-top: 0; background-color: #fff; ">
    ...
    <div class="topbar d-flex align-items-center">
      <div class="container d-flex justify-content-center justify-content-md-between">
        <div class="contact-info d-flex align-items-center">
          <i class="bi bi-envelope d-flex align-items-center"><a href="stevemetenou@gmail.com">stevemetenou@gmail.com</a></i>
...
<body>
  <section id="contain">
    ...
    <h1>Comment l'utiliser </h1>
     <div class="first">
      <p>Ma Candidature</p>
      <a href="candidature.jsp">Aller Directement dessus</a>
     </div>
     <div class="box">
     ...
     <div class="first">
      <p>Ma Fiche</p>
      <a href="Ma_fiche.jsp">Aller Directement dessus</a>
     </div>
     <div class="box">
     ...
     <div class="first">
      <p>Mon resultat</p>
      <a href="Mon_resultat.jsp">Aller Directement dessus</a>
     </div>
     <div class="box">
      
     </div>
     
     <a href="../login.jsp" class = "reserved">Espace reserver</a>
  </section>

                        ...
                        <div class="col-lg-12 ">
                          <form id="contact-form" method="post" action="" role="form">
                            <div class="row">
                              ...
                              <h4>Informations li̩es au concour</h4>
                              ...
                              <div class="col-md-6">
                                <label for="name">Qualit̩ du candidat </label>
                                <div class="">
                                  <p>Valeur</p>
                                </div>
                              </div>
                              ...
                              <div class="mdi-button">
                                <a href="#"><button type="button" class="btn btn-outline-primary btn-icon-text">
                                    <i class="mdi mdi-file-check btn-icon-prepend"></i> Soumettre </button></a>

                                <a href="#"> <button type="button" class="btn btn-outline-primary btn-icon-text">
                                    <i class="mdi mdi-download btn-icon-prepend"></i> T̩l̩charger </button>
                                  <p class="comments"></p>
                                </a>
                                <p class="comments"></p>
                              </div>

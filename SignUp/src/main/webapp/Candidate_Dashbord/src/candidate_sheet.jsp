                            ...
                            <div class="row">
                              ...
                              <div class="col-md-6">
                                <div class="input-group">
                                  ...
                                  <div class="p-t-10">
                                    <label class="radio-container m-r-45">J'ai mon matricule
                              ...
                              <div class="col-md-6">
                                <div class="input-group">
                                  ...
                                  <div class="p-t-10">
                                    ...
                                    <label class="radio-container">Je n'ais plus mon matricule
                              ...
                              <div class="col-md-12">
                                ...
                                <input id="firstname" type="" name="firstname" class="form-control"
                              ...
                              <div class="mdi-button">
                                <a href="sheet_preview.jsp"><button type="button"
                                    ...
                                    <i class="mdi mdi-file-check btn-icon-prepend"></i> Afficher ma candidature
                                  </button></a>

                                <a href="candidate_candidacy.jsp"><button type="button"
                                    class="btn btn-outline-primary btn-icon-text">
                                    <i class="mdi mdi-view-list btn-icon-prepend"></i> Modifier ma candidature
                                  </button></a>
                                <p class="comments"></p>
                              </div>
